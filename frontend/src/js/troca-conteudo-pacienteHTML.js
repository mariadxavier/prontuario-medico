...
$listAside = document.querySelectorAll(".aside-select"); //seleciona os dois itens do aside, as li PESSOAL e HISTÓRICO
$listContainers = document.querySelectorAll(".container"); // lista com containers de conteudo (PESSOAL e HISTÓRICO)
